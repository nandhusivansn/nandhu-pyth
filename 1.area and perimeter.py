ഈകൂradius=int(input("enter the radius of the circle"))
...
'matthew.weiss@sqltutorial.org','650.123.1234', '1996-07-18′,19,8000.00,100,5), (121, 'Adam', 'Fripp', adam.fripp@sqltutorial.org', '650.123.2234', '1997-04-10',19,8200.00,100,5), (122, 'Payam', 'Kaufling', 'payam.kaufling@sqltutorial.org', '650.123.3234', '1995-05-01',19,7900.00,100,5), (123, 'Shanta', 'Vollman', 'shanta.vollman@sqltutorial.org', '650.123.4234','1997-10-10',19,6500.00,100,5), (126, Irene', 'Mikkilineni', 'irene.mikkilineni@sqltutorial.org', '650.124.1224', '1998-09-
...
24',16,8600.00,100,8), (177,'Jack', 'Livingston', 'jack.livingston@sqitutorial.org', NULL, '1998-04-
...
04',17,4000.00,123,5), (193, 'Britney', 'Everett', 'britney.everett@sqitutorial.org', '650.501.2876', '1997-
...
michael.hartstein@sqitutorial.org, '515.123.5555', '1996-02-17',10,13000.00,100,2),
...
INSERT INTO dependents (dependent_i,first_name.last_name,relationship, employee_id) VALUES (1,'Penelope', 'Gietz', 'Child',206), (2, 'Nick', 'Higgins', 'Child',205), (3, 'Ed', 'Whalen', 'Child',200), (4,'Jennifer', 'King', 'Child', 100), (5, 'Johnny', 'Kochhar', 'Child',101), (6, 'Bette', 'De Haan', 'Child', 102), (7, Grace', 'Faviet', 'Child', 109), (8, 'Matthew', 'Chen', 'Child', 110), (9,'Joe', 'Sciarra', 'Child',111), (13,'Uma', 'Mavris', 'Child',203), (14, 'Vivien', 'Hunold', 'Child', 103), (15, 'Cuba', 'Ernst','Child',104), (19, Bob', 'Hartstein', 'Child', 201), (20, 'Lucille', 'Fay','Child', 202), (21, 'Kirsten', 'Baer', 'Child',204), (22, Elvis', 'Khoo', 'Child',115), (23, 'Sandra', 'Baida', 'Child',116), (24,'Cameron', 'Tobias', 'Child',117),
...
'Child',114), (28, "Woody', 'Russell', 'Child',145), (29,'Alec', 'Partners', 'Child',146), (30, 'Sandra', 'Taylor' 'Child',176);